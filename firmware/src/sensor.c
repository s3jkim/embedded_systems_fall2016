...
void IR_Transmit_Packaging(){
    ir_msg_header.source = ROVER_1;
    ir_msg_header.destination = ROVER_2;
    ir_msg_header.sequence = ir_tx_sequence;
    ir_msg_data = sensorData.distance;

    ir_tx_checksum = ir_tx_checksum + ir_msg_header.source + ir_msg_header.destination + ir_msg_header.sequence;
    ir_tx_checksum += ir_msg_data;
    ir_tx_checksum += ir_tx_checksum;

    ir_msg_footer.checksum = ir_tx_checksum;

    ir_tx_sequence++;
}

void IR_Receive_Packaging(){
    ir_rx_checksum = ir_rx_msg_header.source + ir_rx_msg_header.destination + ir_rx_msg_header.sequence;
    ir_rx_checksum += ir_rx_msg_data;
    ir_rx_checksum += ir_rx_msg_footer.checksum;
